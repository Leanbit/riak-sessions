...
#
# Usage (Rack builder):
#   use RiakSessionStore
#
# Usage (Rails):
#   config.middleware.use RiakSessionStore
#
# Usage (Rails 2.3), requires you to swap out the default store:
#   config.middleware.swap ActionController::Session::CookieStore, RiakSessionStore
#
# For configuration options, see #initialize.
class RiakSessionStore < Rack::Session::Abstract::ID
